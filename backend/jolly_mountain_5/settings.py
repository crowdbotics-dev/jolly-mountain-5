"""
Django settings for jolly_mountain_5 project.
...
ROOT_URLCONF = 'jolly_mountain_5.urls'
...
WSGI_APPLICATION = 'jolly_mountain_5.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Jolly Mountain Support <support@jolly-mountain-5.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jolly_mountain_5 API",
    "DESCRIPTION": "API documentation for jolly_mountain_5 App",
    "VERSION": "v1",
}
